        ...
        <table class="w-full text-[13px] min-w-[640px]">
            ...
            <tbody class="divide-y">
                @forelse ($printers as $printer)
                    <tr>
                        <td class="px-3 py-2 text-gray-400">{{ $printers->firstItem() + $loop->index }}</td>
                        <td class="px-3 py-2">{{ $printer->KdPrn }}</td>
                        <td class="px-3 py-2 font-semibold text-gray-900">{{ $printer->NmPrn }}</td>
                        <td class="px-3 py-2 text-gray-600">{{ $printer->NoUrut }}</td>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-4 py-6 text-center text-gray-400">Belum ada data printer.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>

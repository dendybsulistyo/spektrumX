<x-app-layout>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 max-w-2xl">
        <form method="POST" action="{{ route('produk.update', $produk) }}" class="space-y-4">
            @csrf
            @method('PUT')
            ...
            <div class="pt-2 flex gap-3">
                ...
                <a href="{{ route('produk.index') }}" class="px-4 py-2 text-sm text-gray-600 hover:underline">Batal</a>
            </div>
        </form>
    </div>
</x-app-layout>

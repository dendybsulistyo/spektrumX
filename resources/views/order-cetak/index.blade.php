<x-app-layout>
    ...
    <div class="bg-white rounded-lg border border-gray-200 overflow-hidden"
        ...
        <div x-data="{ tab: 'indoor' }">
            ...
            @foreach (['indoor' => ['orders' => $indoorOrders, 'rows' => $indoorRows], 'outdoor' => ['orders' => $outdoorOrders, 'rows' => $outdoorRows], 'artwork' => ['orders' => $artworkOrders, 'rows' => $artworkRows]] as $tabKey => $tabData)
                <div x-show="tab === '{{ $tabKey }}'" @if($tabKey!=='indoor') x-cloak @endif class="overflow-x-auto">
                    <table class="w-full text-sm min-w-[640px]">
                        ...
                        <tbody class="divide-y">
                            ...
                            @empty
                                <tr><td colspan="7" class="px-4 py-8 text-center text-gray-400">Tidak ada order di antrian cetak.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>

        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y">
                @forelse ($operators as $operator)
                    <tr>
                        <td class="px-4 py-3 text-gray-400">{{ $operators->firstItem() + $loop->index }}</td>
                        <td class="px-4 py-3">{{ $operator->KdOpr }}</td>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-4 py-8 text-center text-gray-400">Belum ada data operator.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>

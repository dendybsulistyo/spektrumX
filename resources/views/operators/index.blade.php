        ...
        <table class="w-full text-[13px] min-w-[640px]">
            <thead class="bg-gray-50 text-left text-xs uppercase text-gray-500">
                <tr>
                    ...
                    <th class="px-3 py-2">Nama Operator</th>
            ...
            <tbody class="divide-y">
                @forelse ($operators as $operator)
                    <tr>
                        <td class="px-3 py-2 text-gray-400">{{ $operators->firstItem() + $loop->index }}</td>
                        <td class="px-3 py-2">{{ $operator->KdOpr }}</td>
                        <td class="px-3 py-2 font-semibold text-gray-900">{{ $operator->NmOpr }}</td>
                        <td class="px-3 py-2">
                            @if ($operator->Status)
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-4 py-6 text-center text-gray-400">Belum ada data operator.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>

    ...
    <div class="bg-white rounded-lg border border-gray-200 overflow-hidden">
        ...
        <div class="p-4 border-b">
            <form method="GET" class="flex gap-2">
                ...
                @if (request('search'))
                    <a href="{{ route('order-artwork.index') }}" class="px-4 py-2 text-sm text-gray-500 hover:underline">Reset</a>
                @endif
            </form>
        </div>

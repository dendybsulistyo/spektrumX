        ...
        <table class="w-full text-[13px] min-w-[640px]">
            <thead class="bg-gray-50 text-left text-xs uppercase text-gray-500">
                <tr>
                    ...
                    <th class="px-3 py-2">Jumlah Bahan</th>
            ...
            <tbody class="divide-y">
                @forelse ($kategoriBahanOutdoor as $item)
                    <tr>
                        <td class="px-3 py-2 text-gray-400">{{ $kategoriBahanOutdoor->firstItem() + $loop->index }}</td>
                        <td class="px-3 py-2">{{ $item->KdGrup }}</td>
                        <td class="px-3 py-2 font-semibold text-gray-900">{{ $item->NmGrup }}</td>
                        <td class="px-3 py-2 text-gray-600">{{ $item->NoUrut }}</td>
                        <td class="px-3 py-2 text-gray-600">{{ $item->bahan_count }}</td>

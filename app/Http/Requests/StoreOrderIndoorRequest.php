...
class StoreOrderIndoorRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'KdCust' => ['required', 'string', 'exists:aman_customer_reguler,KdCust'],
            'KdOpr' => ['required', 'string', 'exists:aman_editor,KdOpr'],

            'items' => ['required', 'array', 'min:1'],
            'items.*.KdProd' => ['required', 'string', 'exists:z_produk_NamaProduk_INDOOR_CEK,KdProd'],

...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Historical orders predate this pipeline — mark them finished so they never
        // surface in the new kasir/desain/cetak/qc/pengambilan queues.
        DB::table('indm')->update([
            'status' => 'selesai',
            'status_bayar' => 'lunas',
        ]);
    }
